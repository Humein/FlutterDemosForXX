...
import 'package:flutter_journey/day10/17/widgets/color_chooser.dart';
...
class SlidePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var colorChooser = StoreBuilder<AppState>(builder: (context, store) =>
        ColorChooser(
          initialIndex:Cons.them_colors.indexOf(store.state.themeState.primaryColor)??4,
          colors:Cons.them_colors ,
          onChecked: (color)=> store.dispatch(ActionSwitchTheme(ThemeData(primaryColor: color))),
        ));
