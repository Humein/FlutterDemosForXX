...
import 'package:flutter_journey/day10/12/app/bloc/search/search_bloc.dart';
import 'package:flutter_journey/day10/12/app/bloc/search/search_event.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<HomeBloc,HomeState>(builder: (_,state)=>_buildByState(state)),
    );
  }
