  ...
  Widget _buildByState(AsyncSnapshot<StateType> snapshot) {
    if(snapshot.connectionState==ConnectionState.waiting){
      ...
      switch (snapshot.data) {
        case StateType.loading:return LoadingPage();
        case StateType.empty:return EmptyPage();
        case StateType.error:return ErrorPage();
        case StateType.fill:
          return RefreshIndicator(
              onRefresh: _model.getListData,
              child: FillPage(_model.data));
      }
  }
