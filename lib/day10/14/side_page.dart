...
import 'package:flutter_journey/day10/14/app/provider/i18n/i18n.dart';

import 'app/cons.dart';
import 'package:flutter_journey/day10/14/app/provider/theme_state.dart';
...
class LanguageChooser extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return  Consumer2<ThemeState,LocaleState>(builder: (_,theme,state,__)=>ExpansionTile(
