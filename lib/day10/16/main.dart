...
import 'package:flutter_journey/day10/16/app/redux/count_redux.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, ThemeData>(
      converter: (store)=>store.state.themeState.themeData,
        builder: (context, themeData) => MaterialApp(//对点消费
              title: 'Flutter Demo',
              theme: themeData, //获取数据
