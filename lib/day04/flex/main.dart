...
///////----------------------4.4.1.6  Flex布局使用练习2--------------------
    ...
    var top = Row(children: <Widget>[ //顶部
    ...
    var content = Column( //中间文字内容
        ...
        children: <Widget>[
          ...
          SizedBox(height: 5),
          Text("也就是水平排放还是竖直排放，可以看出默认情况下都是主轴顶头,"
    ...
    var center = Row( //中间的部分
        children: <Widget>[
          ...
          ClipRRect(borderRadius: BorderRadius.all(Radius.circular(5)),
              child: Image(width: 80, height: 80, fit: BoxFit.cover,
    ...
    var show = Container(height: 160, margin: EdgeInsets.all(5),
