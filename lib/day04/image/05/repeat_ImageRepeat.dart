...
class _ImageRepeatDemoState extends State<ImageRepeatDemo> {
  ...
  Widget build(BuildContext context) {
    var imgLi = ImageRepeat.values.map((repeat)=>
        Column(children: <Widget>[
          Container( margin: EdgeInsets.all(5),
              width: 150,   height: 60, color: ColorUtils.randomColor(),
              child: Image(
                image: AssetImage("images/wy_30x20.jpg"), repeat: repeat, )),
          Text(repeat.toString())])).toList();
