...
import 'package:flutter_journey/day11/todo/api/logic/validator.dart';
import 'package:flutter_journey/day11/todo/app/router/router.dart';
...
import 'package:flutter_journey/day11/todo/pages/loading_page.dart';
        ...
        body: BlocConsumer<LoginBloc, LoginState>(
            ...
            builder: (_, state) => Stack(
                  ...
                  children: <Widget>[
                    ...
                    if (state is LoginLoading) Positioned(
                        bottom: 100,
                        child: LoadingPage(msg: '登录中...',))
                  ],
                )));
  }
